...
from modules.nn_net.ifc.inf_fid_ode_2d import InfFidNet2D
...
def ifc_gpt_2d_test(dataset, exp_config):
    ...
    ifc_model = InfFidNet2D(
        ...
        A_width   = ifc_config.A_width,
        A_depth   = ifc_config.A_depth,
    ...
    for ie in range(max_epochs):
        loss = ifc_model.eval_loss(Xtr_list, ytr_list, t_list_tr)
        ...
        if ie % ifc_config.test_interval == 0 or (ie == max_epochs - 1):
            ...
            pred_dict = ifc_model.eval_pred(Xte_list, t_list_te)
